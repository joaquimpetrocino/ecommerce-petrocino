                ...
                <div className="p-6 space-y-4">
                    <div>
                        ...
                        <input
                            ...
                            onChange={(e) => updateCurrentSettings("storeName", e.target.value)}
                            className="w-full px-4 py-3 border border-neutral-300 rounded-lg font-body focus:border-primary focus:ring-2 focus:ring-primary/20 outline-none"
                ...
                <div className="p-6 space-y-4">
                    ...
                    {currentSettings.logoUrl && (
                        <div className="mt-4 border-t border-neutral-100 pt-4">
                            <p className="text-sm font-body font-medium text-neutral-700 mb-2">Logo Atual:</p>
                            <div className="flex items-center gap-4">
                                <img
                                    src={currentSettings.logoUrl}
                                    alt="Logo Preview"
                                    className="max-h-16 object-contain border border-neutral-200 rounded-lg p-2 bg-neutral-100"
                                />
                                <button
